...
2. Improves maintainability: Makes the intent clear to others reading your code.
3. Prevents unexpected behavior: Avoids silent bugs caused by mismatched signatures.
*/
        cout << "Dog barks" << endl;
    }
};
